...
/**
 * @generated from protobuf message Test_examples.HelloRequest
 */
...
/**
 * @generated from protobuf message Test_examples.HelloResponse
 */
...
class HelloRequest$Type extends MessageType<HelloRequest> {
    constructor() {
        super("Test_examples.HelloRequest", [
...
/**
 * @generated MessageType for protobuf message Test_examples.HelloResponse
 */
export const HelloResponse = new HelloResponse$Type();
/**
 * @generated ServiceType for protobuf service Test_examples.TestService
 */
export const TestService = new ServiceType("Test_examples.TestService", [
